...
public class InMemDBTest {
  ...
  static void init_store() {
    ...
    RobotPart robotMobility =
        new RobotPart("Q", "Mobility", "Mobility with antigravity engine", 0.1, 6);
  ...
  void should_not_allow_add_column_with_duplicate_name() {
    ...
    assertThatThrownBy(() -> DATABASE.addColumnToRow("P", col))
        .isInstanceOf(DBInternalException.class)
        .hasMessageContaining("duplicate column name found");
  }
}
