...
public class OrderARobotAcceptanceTest {
    ...
    @Test
    void shouldNotGetNull() {
        given(inventoryRepository.getAvailableFromDB(anyString())).willReturn(10);
        inventoryRepository.getAvailableFromDB("anyString()");
        then(inventoryRepository).should(times(1)).getAvailableFromDB(anyString());
        given(inventoryRepository.reduceSinglePartInventoryAvail(anyString(), eq(1))).willReturn(true);
        inventoryRepository.reduceSinglePartInventoryAvail("anyString()", 1);
        then(inventoryRepository).should(times(1)).reduceSinglePartInventoryAvail(anyString(), anyInt());
