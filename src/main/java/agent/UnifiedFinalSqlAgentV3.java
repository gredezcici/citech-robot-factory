 ...
 */
public final class UnifiedFinalSqlAgentV3 {
    private UnifiedFinalSqlAgentV3() {
    }
    ...
    public static void onJdbcExecute(Object self, String method, Object[] args) {
        try {
            ...
            // avoid duplicate JDBC line while MyBatis is actively logging
    ...
    static final class DriverSpecific {
        ...
        static void registerFromDriver(java.sql.Connection c, String url, java.util.Properties props) {
            try {
                ...
                CONN_CREDS.put(c, ci); // masking applied later in readConnInfo
            } catch (Throwable ignored) {
            }
        }
    ...
    static final class Filter {
        ...
        static final double SAMPLE = parseDouble("sql.agent.sample", 1.0); // 0.0..1.0
